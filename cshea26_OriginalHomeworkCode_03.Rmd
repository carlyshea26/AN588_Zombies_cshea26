...
f <- curl("https://github.com/fuzzyatelin/fuzzyatelin.github.io/blob/master/AN588_Spring25/zombies.csv")
zombie <- read.csv(f, header = TRUE)
head(zombie) #shortening reading frame to something more manageable 
```
```{r}
