...
```{r}
par(mfrow = c(2, 3))
boxplot(zombies$height)
boxplot(zombies$weight)
boxplot(zombies$age)
boxplot(zombies$zombies_killed)
boxplot(zombies$years_of_education)

#WRONG^
#YOU NEED TO USE GGPLOT
p <- ggplot(data = d, aes(x = Gemder, y = log(Body_mass_female_mean)))  #define the variables
